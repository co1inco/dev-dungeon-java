...
public class IllusionRiddleLevel extends DevDungeonLevel implements ITickable {
    ...
    public static final MonsterType[] MONSTER_TYPES = new MonsterType[] {
    ...
    public IllusionRiddleLevel(LevelElement[][] layout, DesignLabel designLabel, List<Coordinate> customPoints) {
        ...
        this.secretPassages = new Coordinate[][] {
    ...
    private void onInitialize() {
        ...
        Entity b = EntityUtils.spawnBoss(
            BOSS_TYPE,
            this.levelBossSpawn,
            (e) -> {
    ...
    private void spawnChestsAndCauldrons() {
        for (Coordinate chestSpawnTileCoordinate : this.chestSpawns) {
            ...
            try {
                ...
                throw new RuntimeException("Failed to create chest entity at " + chestSpawnTileCoordinate, e);
            }
            PositionComponent pc = newIllusionRiddleLevelChestEntity
                .fetch(PositionComponent.class)
                .orElseThrow(
                    () -> MissingComponentException.build(newIllusionRiddleLevelChestEntity, PositionComponent.class));

            pc.position(chestSpawnTileCoordinate.toCenteredPoint());
            InventoryComponent ic = newIllusionRiddleLevelChestEntity
                .fetch(InventoryComponent.class)
                .orElseThrow(
                    () -> MissingComponentException.build(newIllusionRiddleLevelChestEntity, InventoryComponent.class));
